  ...
  return (
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="flex flex-col justify-center items-center lg:ml-auto xl:w-[38rem] mt-4">
          ...
          <div className=" relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
            ...
            <ul>
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-[#FFFFFF]/15 rounded-xl -rotate-${index * 45
                      }`}
                  >
                    <img
                      className="m-auto"
